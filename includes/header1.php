        ...
        <div class="container mx-auto px-4">
            <nav class="flex items-center justify-between py-4" role="navigation">
                ...
                <div class="flex items-center space-x-8">
                    <!-- Logo -->
                    <a href="<?php echo BASE_URL; ?>" class="flex items-center group focus:outline-none focus:ring-[#a53860] focus:ring-2 focus:ring-opacity-30 rounded-lg" aria-label="<?php echo SITE_NAME; ?> - Go to homepage">
                                    ...
                                    <div class="p-6">
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <div class="space-y-2">
                                                    <a href="/ecommerce-project/products/product_list.php?category=casual" class="block text-text-secondary hover:text-text-primary hover:bg-gray-light/50 px-3 py-2 rounded-lg transition-all duration-200">Casual Dresses</a>
                                                    <a href="/ecommerce-project/products/product_list.php?category=formal" class="block text-text-secondary hover:text-text-primary hover:bg-gray-light/50 px-3 py-2 rounded-lg transition-all duration-200">Formal Wear</a>
                                                    <a href="/ecommerce-project/products/product_list.php?category=evening" class="block text-text-secondary hover:text-text-primary hover:bg-gray-light/50 px-3 py-2 rounded-lg transition-all duration-200">Evening Dresses</a>
                                                </div>
                                            </div>
                                            <div>
        ...
        <div class="bg-white/95 backdrop-blur-lg">
            <div class="container mx-auto px-4 py-4">
                    ...
                    <ul id="mobile-dresses-dropdown" class="pl-4 hidden mt-2 space-y-3">
                        <li>
                            ...
                            <div class="space-y-1 mt-1">
                                <a href="/ecommerce-project/products/product_list.php?category=casual" class="block text-text-secondary hover:text-text-primary pl-2 py-1 transition-colors duration-200">Casual Dresses</a>
                                <a href="/ecommerce-project/products/product_list.php?category=formal" class="block text-text-secondary hover:text-text-primary pl-2 py-1 transition-colors duration-200">Formal Wear</a>
                                <a href="/ecommerce-project/products/product_list.php?category=evening" class="block text-text-secondary hover:text-text-primary pl-2 py-1 transition-colors duration-200">Evening Dresses</a>
                            </div>
                        </li>
                        <li>
                ...
                <div class="border-t border-border-light pt-4 mt-4">
                    ...
                    <!-- Order History -->
                    <a href="<?php echo BASE_URL; ?>/account/orders.php" class="mobile-menu-item flex items-center text-text-primary hover:text-accent-pink transition-colors duration-200">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                    ...
                    <!-- Settings -->
                    <a href="<?php echo BASE_URL; ?>/account/settings.php" class="mobile-menu-item flex items-center text-text-primary hover:text-accent-pink transition-colors duration-200">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                        </svg>
